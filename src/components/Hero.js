...
export const Hero = () => {
  return (
    <div className="flex flex-col items-center pt-[100px] mx-auto w-full gap-5 font-Poppins h-screen px-2 ">
      <div className="max-w-[180px] max-h-[180px] rounded-full border">
        <Image
          src={avatar}
          alt="avatar"
          height={180}
